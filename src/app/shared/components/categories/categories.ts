...
export class Categories {
  ...
  statementFilteredItem: { value: string, icon: string } = {value: '', icon: ''};
  statementFilterCategoryItems: { value: string, icon: string }[] = [
    {
      value: 'جشنواره زمستان',
   ...
   */
  onRemoveStatementFilteredItem(statementFilteredItem: { value: string; icon: string }) {
    this.statementFilteredItem = {value: '', icon: ''};
